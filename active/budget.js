...
function addBill(addBill){
    ...
    newBill.id = "bill";
    var inject = "\t\t\t<input type=\"text\" name=\"name\" value=\"New Bill\" class=\"billClass\">\n" +
        ...
        "\t\t\t<button class=\"payBill\" onclick=\"payBill()\">Pay Bill</button> \n" +
...
function newCategory(addCat){
    ...
    var inject = "\t\t<div id = \"catStyle\">" +
        "\t\t\t<input type=\"text\" name=\"name\" value=\"New Category\" class=\"categoryInput\">\n" +
